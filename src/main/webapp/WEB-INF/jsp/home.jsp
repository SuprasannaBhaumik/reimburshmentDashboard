...
jQuery(document).ready(function($) {
	...
	jQuery("#last5TransGrid").jqGrid({
           ...
           colModel:[
               {name:'Issue',index:'Issue', width:60, sorttype:"int"},
               {name:'Description',index:'Description', width:60,sortable:false},
               {name:'Status',index:'Status', width:60, sorttype:"string"},
           ],
           multiselect: true,
           height: "40%",
           rows:5,
	...
	<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" 
				...
				aria-selected="true" 
				aria-expanded="true">
					<a href="#tabs-1" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-8">Employee</a>
			</li>
			<li class="ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-2" aria-labelledby="ui-id-9" aria-selected="false" aria-expanded="false"><a href="#tabs-2" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-9">Manager</a></li>
		</ul>
		<div id="tabs-1">
			<div class="question">
			...
			<div class="answer" style="display:none;"><a target="_blank" href="http://www.google.com">Link to New Window</a></div>
		</div>
		<div id="tabs-2">
			<div class="question">
				<span>+</span>Approved Request
			</div>
			<div class="answer" style="display:none;">jqGridTable with approved records</div>
			<br/>
			<div class="question">
				<span>+</span>Pending Request
			</div>
			<div class="answer" style="display:none;">jqGridTable with pending records</div>
			<br/>
			<div class="question">
				<span>+</span>Cancelled Request
			</div>
			<div class="answer" style="display:none;">jqGridTable with cancelled records</div>
		</div>
	</div>
	<div ng-app>
	 10 + 20 ::: {{10+20}}
	 <br/>
	 {{ {name:'Suprasanna',age:'30'}.name }}	
	</div>
	<b>{{10+20}}</b>
</body>
</html>